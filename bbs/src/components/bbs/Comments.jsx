...
import {
    updateDoc, addDoc, collection, getFirestore, onSnapshot, orderBy, where, query, deleteDoc, doc
                    ...
                    <div key={com.id}>
                        <Row>
                            ...
                            {email === com.email && !com.isEdit &&
                                <Col>
                                    <Button onClick={() => onClickUpdate(com.id)} variant='success' size='sm' className='me-2'>수정</Button>
